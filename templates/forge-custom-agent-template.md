...
{{#if (not tool_supported)}}
- You have access to set of tools as described in the **Available Tools** section.
...
{{#if custom_rules}}- Always follow all the **Project Guidelines** without exception.{{/if}}
