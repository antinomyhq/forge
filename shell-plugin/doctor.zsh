...
if command -v forge &> /dev/null; then
    ...
    print_result fail "Forge binary not found in PATH" "Installation: curl -fsSL https://raw.githubusercontent.com/Zetkolink/forgecode/main/scripts/install.sh | sh"
fi
