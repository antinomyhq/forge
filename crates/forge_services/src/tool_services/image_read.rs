...
use forge_app::{ConfigReaderInfra, EnvironmentInfra, FileInfoInfra, ImageReadService};
...
impl<F: FileInfoInfra + EnvironmentInfra + ConfigReaderInfra + forge_app::FileReaderInfra> ImageReadService
