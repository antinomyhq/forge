...
//     let section =
// Element::new("div.section").append(Element::new("h2").text("Agents"));
...
//                     .model
//                     .as_ref()
//                     .map(|model| Element::new("span").text(format!("Model:
// {model}"))),             );
...
//             agent_div =
//                 agent_div.append(Element::new("p").text(format!("Temperature:
// {temperature}")));         }

//         // Add max turns if available
//         if let Some(max_turns) = agent.max_turns {
//             agent_div = agent_div.append(Element::new("p").text(format!("Max
// Turns: {max_turns}")));         }

//         // Add max walker depth if available
//         if let Some(max_walker_depth) = agent.max_walker_depth {
//             agent_div = agent_div
//                 .append(Element::new("p").text(format!("Max Walker Depth:
// {max_walker_depth}")));         }
