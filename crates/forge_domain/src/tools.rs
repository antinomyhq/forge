...
/// ONLY works with files, NOT directories, as it will ALWAYS fail.
/// Ideal for analyzing code, configuration files, documentation, or
/// textual data. Returns the content as a string with line number prefixes
/// by default. For files larger than 2,000 lines, the tool automatically
/// returns only the first 2,000 lines. You should always rely on this
...
pub struct FSRead {
    /// The path of the file to read, always provide absolute paths. ONLY
    /// provide file path, NOT directory path, as it will ALWAYS fail.
    pub path: String,
