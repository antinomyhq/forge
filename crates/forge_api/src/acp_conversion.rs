...
//! and Forge domain types. These are presentation-layer concerns with no
...
use anyhow::Result;
use forge_domain::{
    Agent, AgentId, Attachment, AttachmentContent, Image, ToolCallFull, ToolName, ToolOutput,
    ToolValue,
};
...
pub fn acp_resource_to_attachment(resource: &acp::EmbeddedResource) -> Result<Attachment> {
